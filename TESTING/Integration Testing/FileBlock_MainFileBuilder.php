...
include_once("../../php/view/Components/FileBlock_MainFileBuilder.php");
...
class Test_FileBlock_MainFileBuilder{
    var $testID;
    var $testFirstName;
    var $testLastName;
    var $testAddrNum;
    ...
    function doTest(){
        $toRet = "FAILED";
        try{
            $MainEventBuilder = new FileBlock_MainFileBuilder($this->testID);
...
$test = new Test_FileBlock_MainFileBuilder($toPass);
echo $test->doTest();
?>