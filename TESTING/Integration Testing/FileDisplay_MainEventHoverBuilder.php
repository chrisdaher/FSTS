...
include_once("../../php/view/Components/FileDisplay_MainEventHoverBuilder.php");
...
class Test_FileDisplay_MainEventHoverBuilder{
    var $testID;
    var $testName;
    var $testStartDate;
    var $testEndDate;
    ...
    function doTest(){
        $toRet = "FAILED";
        try{
            $MainEventBuilder = new FileDisplay_MainEventHoverBuilder($this->testID);
...
$test = new Test_FileDisplay_MainEventHoverBuilder($testRow);
echo $test->doTest();
?>