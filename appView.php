...
<head>
	...
	<script src='bin//codebase/ext/dhtmlxscheduler_timeline.js' type="text/javascript" charset="utf-8"></script>
    ...
    <!-- Main-->
    <script src="js/SchedulerApp.js" type="text/javascript" charset="utf-8"></script>
...
<body>
	...
	<div oncontextmenu="" id="thescheduler" class="dhx_cal_container" style='width:1280px; height:1024px;'>
		<div class="dhx_cal_navline" id="navline">
			<div class="dhx_cal_prev_button" id="prev_button" style="display:none">&nbsp;</div>
			<div class="dhx_cal_next_button" id="next_button" style="display:none">&nbsp;</div>
			<div class="dhx_cal_today_button" id="today_button" style="display:none"></div>
			<div class="dhx_cal_date" id="lbl_date" style="display:none"></div>
			<div class="dhx_cal_tab" id="day_tab" name="day_tab" ></div>
			<div class="dhx_cal_tab" id="week_tab" name="week_tab" style="left:76px;"></div>
			<div class="dhx_cal_tab" id="month_tab" name="month_tab" style="right:76px;display:none;"></div>
			<div class="dhx_cal_tab" id="workweek_tab" name="workweek_tab" style="right:280px;display:none;"></div>
